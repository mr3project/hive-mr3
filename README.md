...
This repository (default branch `master3`) is a fork of Apache Hive 3.1.2 [branch-3.1](https://github.com/apache/hive/tree/branch-3.1).
It applies over 600 patches obtained from the master branch for fixing critical bugs and stabilizing performance.

This repository is maintained as part of developing Hive on MR3, but can also be used for building Apache Hive.
In order to build Apache Hive, ignore the last two commits:
