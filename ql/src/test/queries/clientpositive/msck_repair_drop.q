...
dfs -rm -r -f ${system:test.local.warehouse.dir}/repairtable_n1/p1=2;
...
dfs -rm -r -f ${system:test.local.warehouse.dir}/repairtable_n1/p1=3;
...
dfs -rm -r -f ${system:test.local.warehouse.dir}/repairtable_n1/p1=4;
