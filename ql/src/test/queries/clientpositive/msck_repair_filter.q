...
dfs -rm -r -f ${system:test.local.warehouse.dir}/repairtable_filter/p1=bbsc;
MSCK REPAIR TABLE default.repairtable_filter SYNC PARTITIONS (p1='bbsc');
show partitions repairtable_filter;

dfs -rm -r -f ${system:test.local.warehouse.dir}/repairtable_filter/p1=bbw;
MSCK REPAIR TABLE default.repairtable_filter SYNC PARTITIONS (p1 like 'b%');
show partitions repairtable_filter;

dfs -rm -r -f ${system:test.local.warehouse.dir}/repairtable_filter/p1=bba;
