...
-- clean up testdata
dfs -rm -r -f ${system:test.tmp.dir}/testcase_gz;
dfs -rm -r -f ${system:test.tmp.dir}/testcase1/;
dfs -rm -r -f ${system:test.tmp.dir}/testcase2/;
dfs -rm -r -f ${system:test.tmp.dir}/testcase3/;
dfs -rm -r -f ${system:test.tmp.dir}/testcase4/;
