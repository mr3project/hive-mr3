...
public class TestVectorMapJoinFastLongHashSet extends CommonFastHashTable {
  ...
  private static TableDesc keyTableDesc;

  @Before
  public void setUp() throws Exception {
    keyTableDesc = new TableDesc();
    keyTableDesc.setProperties(new Properties());
  }
  ...
  public void testFullMap() throws Exception {
    ...
    VectorMapJoinFastLongHashSet map =
        new VectorMapJoinFastLongHashSet(
            false, false, HashTableKeyType.LONG, CAPACITY, 1f, WB_SIZE, -1, keyTableDesc);
  ...
  public void testExpand() throws Exception {
    ...
    VectorMapJoinFastLongHashSet map =
        new VectorMapJoinFastLongHashSet(
            false, false, HashTableKeyType.LONG, 1, 0.0000001f, WB_SIZE, -1, keyTableDesc);
  ...
  public void testMultipleKeysMultipleValue() throws Exception {
    ...
    VectorMapJoinFastLongHashSet map =
        new VectorMapJoinFastLongHashSet(
            false, false, HashTableKeyType.LONG, LARGE_CAPACITY, LOAD_FACTOR, LARGE_WB_SIZE, -1, keyTableDesc);
  ...
  public void testLargeAndExpand() throws Exception {
    ...
    VectorMapJoinFastLongHashSet map =
        new VectorMapJoinFastLongHashSet(
            false, false, HashTableKeyType.LONG, MODERATE_CAPACITY, LOAD_FACTOR, MODERATE_WB_SIZE, -1, keyTableDesc);
