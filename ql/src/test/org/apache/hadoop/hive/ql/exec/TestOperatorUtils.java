...
public class TestOperatorUtils {
  @Test
  public void testHasMoreGBYsReturnsFalseWhenLimitIs0() {
    // RS-SEL-LIM-FIL
  ...
  @Test
  public void testHasMoreGBYsReturnsFalseWhenNoGBYInBranchAndLimitIsMoreThan0() {
    // RS-SEL-LIM-FIL
    CompilationOpContext context = new CompilationOpContext();
    Operator<?> filter = OperatorFactory.get(context, FilterDesc.class);
    Operator<?> limit = OperatorFactory.get(context, LimitDesc.class);
  ...
  @Test
  public void testHasMoreGBYsReturnsFalseWhenNumberOfGBYIsLessThanLimit() {
    // RS-GBY-SEL-LIM-FIL
    CompilationOpContext context = new CompilationOpContext();
    Operator<?> filter = OperatorFactory.get(context, FilterDesc.class);
    Operator<?> limit = OperatorFactory.get(context, LimitDesc.class);
  ...
  @Test
  public void testHasMoreGBYsReturnsTrueWhenNumberOfGBYIsEqualsWithLimit() {
    // RS-GBY-FIL-SEL-GBY
    CompilationOpContext context = new CompilationOpContext();
  ...
  @Test
  public void testHasMoreGBYsReturnsFalseWhenNumberOfGBYIsEqualsWithLimitButHasAnRSInTheMiddle() {
    // TS-GBY-RS-SEL-GBY
    CompilationOpContext context = new CompilationOpContext();
    Operator<?> gby1 = OperatorFactory.get(context, GroupByDesc.class);
    Operator<?> select = OperatorFactory.get(context, SelectDesc.class);
  ...
  @Test
  public void testHasMoreGBYsReturnsTrueWhenBranchHasJoinAndNumberOfGBYIsEqualsWithLimit() {
    // RS-GBY-FIL--JOIN-GBY
    //     RS-SEL-/
    CompilationOpContext context = new CompilationOpContext();
    Operator<?> gby1 = OperatorFactory.get(context, GroupByDesc.class);
  ...
  @Test
  public void testHasMoreGBYsReturnsFalseWhenBranchHasJoinAndBothJoinBranchesHasLessGBYThanLimit() {
    // RS-GBY-SEL--JOIN
    // RS-GBY-FIL-/
    CompilationOpContext context = new CompilationOpContext();
    Operator<?> join = OperatorFactory.get(context, CommonMergeJoinDesc.class);
