 ...
 */
package com.datamonad.mr3.timeline.security;
...
public class PamAuthenticator extends LoginAuthenticator {
  ...
  public PamAuthenticator(String pamServiceNames) throws AuthenticationException {
    super();
    this.pamServiceNames = pamServiceNames;
