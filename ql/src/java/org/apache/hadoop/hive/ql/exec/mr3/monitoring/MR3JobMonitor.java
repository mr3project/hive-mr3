...
public class MR3JobMonitor {
  ...
  public MR3JobMonitor(
    ...
    // TODO: Currently InPlaceUpdate redirects the output to HiveServer2 console, not Beeline console
    inPlaceUpdate = new InPlaceUpdate(console.getOutStream());
  ...
  private MR3ProgressMonitor progressMonitor(DAGStatus status) {
