...
public class MR3MetricsResource {
  private final MR3MetricsDataManager manager = MR3MetricsDataManager.getInstance();
  ...
  private static UserGroupInformation user(HttpServletRequest request) {
    String name = request.getRemoteUser() == null ? "anonymous" : request.getRemoteUser();
