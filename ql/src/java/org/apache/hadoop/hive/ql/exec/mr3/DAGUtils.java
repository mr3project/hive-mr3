...
public class DAGUtils {
  ...
  public Vertex createVertex(
    ...
    if (isFinal && !(work instanceof MapReduceMapWork)) {
      EntityDescriptor logicalOutputDescriptor = new EntityDescriptor(
          outputKlass.getName(),
          org.apache.tez.common.TezUtils.createByteStringFromConf(vertexJobConf));
  ...
  private Vertex createMapVertex(
    ...
    ByteString userPayload = org.apache.tez.common.TezUtils.createByteStringFromConf(vertexJobConf);
