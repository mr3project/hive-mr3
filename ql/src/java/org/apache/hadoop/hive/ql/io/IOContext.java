...
public class IOContext {
  ...
  private static Map<String, IOContext> getMr3() {
    return IOContext.mr3ThreadLocal.get();
  }
  ...
  public static IOContext get(Configuration conf) {
    ...
    if (engine.equals("mr3") || engine.equals("tez")) {
      Map<String, IOContext> inputNameIOContextMap = getMr3();
  ...
  public static void clear() {
    ...
    IOContext.mr3ThreadLocal.remove();
