...
public class TezConfigurationFactory {
  private static TezConfiguration defaultConf = new TezConfiguration();   // loads tez-site.xml
  ...
  public static JobConf wrapWithJobConfWithoutSourceTracking(Configuration conf) {
    JobConf jc = new JobConf(false);
    copyIntoWithoutSourceTracking(jc, defaultConf);
    copyIntoWithoutSourceTracking(jc, conf);
    return jc;
  }

  private static void copyIntoWithoutSourceTracking(Configuration target, Configuration src) {
